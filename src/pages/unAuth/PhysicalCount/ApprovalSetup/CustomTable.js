...
import { tableHeadings } from "../PhysicalCountUtils";
          ...
          {tableData.map((row, i) => {
            return (
              <TableRow key={row.id} sx={styles.tableRow}>
                ...
                <TableCell>
                  <TextFieldCustom
                    value={row.personNumber.value}
                    label={row.personNumber.label}
                    error={row.personNumber.error}
                    name="personNumber"
                    disabled={row.personNumber.disabled}
                ...
                <TableCell>
                  <SearchInputCustom
                    ...
                    onChange={(e) => onChange(e, i)}
                    onChangeCheckbox={(a, b, c) =>
                      onChangeCheckboxRow(a, b, c, i)
                    }
                    onClickOk={(a) => onClickOk(a, i)}
                  />
                </TableCell>
