...
export const DepartmentFilterDetail = (props) => {
    ...
    return <CustomDialog maxWidth="md" dialogTitle='Filter By Department' open='true' handleClose={handleClose}>
                    ...
                    <Grid container alignItems='center'>
                        <Grid item xs='3'>
                            <Typography fontSize='14px'>
                                <Box textAlign='right' mr={2}>Department</Box>
                            </Typography>
                        </Grid>
                        <Grid item xs='9' >
                            <Box>
